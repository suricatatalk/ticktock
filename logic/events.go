...
type EventFunction func(user model.User, event *EventDTO) (*model.Task, error)

func Start(user model.User, event *EventDTO) (*model.Task, error) {
...
func Pause(user model.User, event *EventDTO) (*model.Task, error) {
	logChange("Pause", user.ID, event.TaskID)
	return changeState(model.Pause, user, event)
}

func Resume(user model.User, event *EventDTO) (*model.Task, error) {
	logChange("Resume", user.ID, event.TaskID)
	return changeState(model.Start, user, event)
}

func Finish(user model.User, event *EventDTO) (*model.Task, error) {
...
func changeState(action int, user model.User, event *EventDTO) (*model.Task, error) {
